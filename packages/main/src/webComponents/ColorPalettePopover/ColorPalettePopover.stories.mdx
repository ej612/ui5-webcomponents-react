...
| **openPopover** | <dl>       |
    ...
    <dt className="methodText">**opener**</dt>
    <dd className="methodText">the element that the popover is opened by</dd>
    <dd><code>HTMLElement</code></dd>

</dl> | Shows the ColorPalettePopover. <b>Note:</b> The method is deprecated and will be removed in future, use
<code>showAt</code> instead. |
| **showAt**      | <dl>
    <dt className="methodText">**opener**</dt>
    <dd className="methodText">the element that the popover is opened by</dd>
    <dd><code>HTMLElement</code></dd>
</dl> | Shows the ColorPalettePopover.                                                                                                       |
